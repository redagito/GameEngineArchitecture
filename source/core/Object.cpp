...
Object::~Object() { inUse()[getId()] = nullptr; }
...
const RTTI& Object::getType() const { return Type(); }
...
size_t Object::getMemoryUsed() const { return sizeof(Object); }

size_t Object::getDiskUsed() const { return sizeof(Object); }